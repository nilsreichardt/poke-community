    ...
    <article className="space-y-8">
      ...
      <section className="space-y-3 text-sm leading-relaxed">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong>Account details.</strong> When you register or sign in we process your email address and password credentials through Supabase. We synchronise your Supabase user ID and optional name or avatar to the public profile table.
          </li>
          <li>
